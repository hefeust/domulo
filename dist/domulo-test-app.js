(function (factory) {
  ...
  var diffAttrsBlocks = function (bmp, oldTagBlock, newTagBlock, patch) {
    var oldAttrsList = getAttrsBlocksList$1 (bmp, oldTagBlock);
    var newAttrsList = getAttrsBlocksList$1 (bmp, newTagBlock);
  ...
  var diffNodesBlocks = function (bmp, oldTagBlock, newTagBlock, patch) {
    var oldNodesList = getNodesBlocksList$1 (bmp, oldTagBlock); 
    var newNodesList = getNodesBlocksList$1 (bmp, newTagBlock); 
